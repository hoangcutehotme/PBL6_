...
// import 'package:training/domain/export/domain_export.dart';
...
class DioClient {
  ...
  //   final String jwtToken = sl.get<SharedPreferenceHelper>().getJwtToken;
  //   dio!.options.headers = {'Content-Type': 'application/json; charset=UTF-8', 'Authorization': 'Bearer $jwtToken','languge': sl<SharedPreferenceHelper>().getLocale};
  // }
  ...
  Future<Response> uploadImages(
    ...
    try {
      ...
      final FormData formData = FormData.fromMap(
          {'files': await MultipartFile.fromFile(files.path.toString())});
      final response = await dio!.post(
        uri,
        data: formData,
        queryParameters: queryParameters,
